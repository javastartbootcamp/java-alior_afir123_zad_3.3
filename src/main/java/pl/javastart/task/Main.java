...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Person on = new Person("Krzysztof", "Nowak");
        Task task1 = new Task("Sprzątanie", "Salon, Łazienka, Kuchnia, Przedpokój i Sypialnia");
        Task task2 = new Task("Pranie", "Kolorowe i białe osobno", 1, ona);

        System.out.println("Zadanie 1 do wykonania to:" + task1.getName() + ", opis: "
                + task1.getDescription() + ", Priorytet: " + task1.getPriority() + ", Osoba odpowiedzialna: " + task1.getPerson());

        System.out.println("Zadanie 2 do wykonania to:" + task2.getName() + ", opis: "
                + task2.getDescription() + ", Priorytet: " + task2.getPriority() + ", Osoba odpowiedzialna: " + task2.getPerson());
        ...
        System.out.println("Ustawiam osobę odpowiedzialną dla zadania 1 i zwiększam priorytet");
